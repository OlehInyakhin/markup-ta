  ...
  return (
    <div className="inline-flex items-center gap-[19px] pb-2">
      <button
        ...
        className="grid h-[24px] w-[24px] grid-cols-3 grid-rows-3 gap-[2px]"
      >
      ...
      <button
        ...
        className="grid h-[24px] w-[24px] grid-cols-[6px_15px] grid-rows-3 items-center gap-x-[3px] gap-y-[2px]"
      >
